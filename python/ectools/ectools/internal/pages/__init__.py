...
from ectools.infrastructure import detail_on_failure
from ectools.infrastructure import retry_for_error
...
class PageBase(object):
    ...
    def select_option_value_by(self, by, by_locator_value, option_value):
        ...
        # we have to convert float or int to string
        if type(option_value) not in (str, unicode):
